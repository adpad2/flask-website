...
from api.projects.athlete_progan.face_restorer.face_model.gpen_model import FullGenerator, FullGenerator_SR
...
class FaceGAN(object):
    def __init__(self, base_dir='./', in_size=512, out_size=None, model=None, channel_multiplier=2, narrow=1, key=None, is_norm=True, device='cuda'):
        self.mfile = 'api/projects/athlete_progan/face_restorer/models/'+model+'.pth'
        self.n_mlp = 8
        self.device = device
